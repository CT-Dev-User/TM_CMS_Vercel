...
const EditCourseCategory = ({ params }) => {
    ...
    useEffect(() => {
        if (!userauth || !userauth.token) {
            ...
            const fetchCourseCategory = async () => {
                setLoading(true)
                try {
                    const response = await axios.get(`https://ot676akte0.execute-api.ap-south-1.amazonaws.com/dev/get-coursecategory-by-id/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`https://ot676akte0.execute-api.ap-south-1.amazonaws.com/dev/edit-course-category/${id}`, formData);
