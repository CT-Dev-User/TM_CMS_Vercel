...
const QueryDataTable = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await axios.get("https://trialtmbackend.vercel.app/api/get-query-data");
  ...
  const handleDelete = async (id) => {
    ...
    if (confirmDelete.isConfirmed) {
      try {
        await axios.delete(`https://trialtmbackend.vercel.app/api/delete-query-data/${id}`);
