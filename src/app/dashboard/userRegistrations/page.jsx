...
const UserRegistration = () => {
  ...
  const getAllUsersData = async () => {
    ...
    try {
      const response = await axios.get("https://tmbackend-bakyrwvoq-tech-momentum.vercel.app/all-users");
  ...
  const updateUserDetails = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://tmbackend-bakyrwvoq-tech-momentum.vercel.app/update-user/${editId}`,
        user
      );
  ...
  const registerUser = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("https://tmbackend-bakyrwvoq-tech-momentum.vercel.app/register", user);
      ...
      if (result.isConfirmed) {
        try {
          const response = await axios.delete(
            `https://tmbackend-bakyrwvoq-tech-momentum.vercel.app/delete-user/${delete_id}`
          );
          if (response.status === 200) {
            Swal.fire({
              title: "Deleted!",
