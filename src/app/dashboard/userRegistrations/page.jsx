...
const UserRegistration = () => {
  ...
  const getAllUsersData = async () => {
    ...
    try {
      const response = await axios.get("https://ot676akte0.execute-api.ap-south-1.amazonaws.com/dev/all-users");
  ...
  const updateUserDetails = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://ot676akte0.execute-api.ap-south-1.amazonaws.com/dev/update-user/${editId}`,
        user
      );
  ...
  const registerUser = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("https://ot676akte0.execute-api.ap-south-1.amazonaws.com/dev/register", user);
      ...
      if (result.isConfirmed) {
        try {
          const response = await axios.delete(
            `https://ot676akte0.execute-api.ap-south-1.amazonaws.com/dev/delete-user/${delete_id}`
          );
          if (response.status === 200) {
            Swal.fire({
              title: "Deleted!",
