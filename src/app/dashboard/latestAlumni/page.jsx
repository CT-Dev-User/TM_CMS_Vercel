...
const OurAlumniCMS = () => {
  ...
  const fetchAlumniData = async () => {
    ...
    try {
      const response = await axios.get(
        "https://ot676akte0.execute-api.ap-south-1.amazonaws.com/dev/get-all-our-alumni-data"
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEdit) {
        await axios.put(
          `https://ot676akte0.execute-api.ap-south-1.amazonaws.com/dev/update-our-alumni-data/${editId}`,
          formDataToSend
        );
        Swal.fire("Success", "Edit alumni successfully", "success");
      } else {
        await axios.post(
          "https://ot676akte0.execute-api.ap-south-1.amazonaws.com/dev/add-our-alumni-data",
          formDataToSend
        );
  ...
  const handleDelete = async (id) => {
    try {
      ...
      if (result.isConfirmed) {
        await axios.delete(
          `https://ot676akte0.execute-api.ap-south-1.amazonaws.com/dev/delete-our-alumni-data/${id}`
        );
