...
const GalleryManagement = () => {
  ...
  const fetchGalleryData = async () => {
    setLoading(true);
    try {
      const response = await axios.get("https://trialtmbackend.vercel.app/api/get-galleries");
  ...
  const handleDelete = async (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await axios.delete(
            `https://trialtmbackend.vercel.app/api/delete-gallery-by-id/${id}`
          );
          fetchGalleryData();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editData) {
        await axios.put(
          `https://trialtmbackend.vercel.app/api/edit-gallery-by-id/${editData._id}`,
          data
        );
        Swal.fire({
          icon: "success",
        ...
        await axios.post("https://trialtmbackend.vercel.app/api/add-gallery", data);
        Swal.fire({
          icon: "success",
          title: "Added!",
