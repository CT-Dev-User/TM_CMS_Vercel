...
const CollaborationTable = () => {
  ...
  const fetchCollaborations = async () => {
    ...
    try {
      const response = await axios.get(
        "https://backend-neon-nu.vercel.app/get-collaborations"
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editMode) {
        await axios.put(
          `https://backend-neon-nu.vercel.app/edit-collaboration-by-id/${editId}`,
          formData
        );
        Swal.fire(
          "Success",
        ...
        await axios.post("https://backend-neon-nu.vercel.app/add-collaboration", formData);
        Swal.fire(
          "Success",
  ...
  const handleRemoveCollaborationData = async (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await axios.delete(
            `https://backend-neon-nu.vercel.app/delete-collaboration-by-id/${id}`
          );
          Swal.fire({
            icon: "success",
            title: "Deleted!",
