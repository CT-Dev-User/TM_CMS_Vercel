...
const PractitionersCMS = () => {
  ...
  const fetchPractitioners = async () => {
    ...
    try {
      const response = await axios.get(
        "https://tmbackend-bakyrwvoq-tech-momentum.vercel.app/get-all-new-practioners-data"
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEdit) {
        await axios.put(
          `https://tmbackend-bakyrwvoq-tech-momentum.vercel.app/edit-new-practioners-data/${editId}`,
          data,
          {
        ...
        await axios.post(
          "https://tmbackend-bakyrwvoq-tech-momentum.vercel.app/add-new-practioners-data",
          data,
          {
            headers: { "Content-Type": "multipart/form-data" },
          }
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(
        `https://tmbackend-bakyrwvoq-tech-momentum.vercel.app/delete-new-practioners-data/${id}`
      );
      fetchPractitioners();
    } catch (error) {
