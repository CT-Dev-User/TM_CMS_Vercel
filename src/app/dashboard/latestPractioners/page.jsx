...
const PractitionersCMS = () => {
  ...
  const fetchPractitioners = async () => {
    ...
    try {
      const response = await axios.get(
        "https://trialtmbackend.vercel.app/api/get-all-new-practioners-data"
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEdit) {
        await axios.put(
          `https://trialtmbackend.vercel.app/api/edit-new-practioners-data/${editId}`,
          data,
          {
        ...
        await axios.post(
          "https://trialtmbackend.vercel.app/api/add-new-practioners-data",
          data,
          {
            headers: { "Content-Type": "multipart/form-data" },
          }
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(
        `https://trialtmbackend.vercel.app/api/delete-new-practioners-data/${id}`
      );
      fetchPractitioners();
    } catch (error) {
