    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editData) {
                ...
                await axios.put(`https://trialtmbackend.vercel.app/update-hire-from/${editData._id}`, formData, {
                    headers: {
                ...
                // Create new record
                await axios.post("https://trialtmbackend.vercel.app/add-hire-from-data", formData, {
                    headers: {
                        "Content-Type": "application/json",
                    },
                });
