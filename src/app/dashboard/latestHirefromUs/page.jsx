...
const HireFromTable = () => {
  ...
  const fetchHireFromData = async () => {
    setLoading(true);
    try {
      const response = await axios.get("https://ot676akte0.execute-api.ap-south-1.amazonaws.com/dev/get-hire-from");
  ...
  const handleDeleteClick = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(`https://ot676akte0.execute-api.ap-south-1.amazonaws.com/dev/delete-hire-from/${id}`);
