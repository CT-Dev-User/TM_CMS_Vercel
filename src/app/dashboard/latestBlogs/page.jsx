...
const BlogManagementTable = () => {
  ...
  const fetchBlogs = async () => {
    setLoading(true);
    try {
      const response = await axios.get("https://ot676akte0.execute-api.ap-south-1.amazonaws.com/dev/get-blogs");
  ...
  const handleDelete = async (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await axios.delete(`https://ot676akte0.execute-api.ap-south-1.amazonaws.com/dev/delete-blog-by-id/${id}`);
          fetchBlogs();
  ...
  const handleFormSubmit = async () => {
    ...
    try {
      if (editMode) {
        await axios.put(
          `https://ot676akte0.execute-api.ap-south-1.amazonaws.com/dev/edit-blog/${editFormData.id}`,
          formDataToSend,
          {
        ...
        await axios.post("https://ot676akte0.execute-api.ap-south-1.amazonaws.com/dev/add-blog", formDataToSend, {
          headers: { "Content-Type": "multipart/form-data" },
        });
