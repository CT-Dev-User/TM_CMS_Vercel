...
const MorqueCMS = () => {
  ...
  const fetchMorqueData = async () => {
    setLoading(true);
    try {
      const response = await axios.get("https://backend-neon-nu.vercel.app/get-morqueData");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEdit) {
        await axios.put(
          `https://backend-neon-nu.vercel.app/update-morqueData/${editId}`,
          formData
        );
        Swal.fire("Success", "Add batch ad successfully", "success");
      } else {
        await axios.post("https://backend-neon-nu.vercel.app/add-morqueData", formData);
  ...
  const handleDelete = async (id) => {
    try {
      ...
      if (result.isConfirmed) {
        await axios.delete(`https://backend-neon-nu.vercel.app/delete-morqueData/${id}`);
