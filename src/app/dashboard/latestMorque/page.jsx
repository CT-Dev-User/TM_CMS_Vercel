...
const MorqueCMS = () => {
  ...
  const fetchMorqueData = async () => {
    setLoading(true);
    try {
      const response = await axios.get("https://ot676akte0.execute-api.ap-south-1.amazonaws.com/dev/get-morqueData");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEdit) {
        await axios.put(
          `https://ot676akte0.execute-api.ap-south-1.amazonaws.com/dev/update-morqueData/${editId}`,
          formData
        );
        Swal.fire("Success", "Add batch ad successfully", "success");
      } else {
        await axios.post("https://ot676akte0.execute-api.ap-south-1.amazonaws.com/dev/add-morqueData", formData);
  ...
  const handleDelete = async (id) => {
    try {
      ...
      if (result.isConfirmed) {
        await axios.delete(`https://ot676akte0.execute-api.ap-south-1.amazonaws.com/dev/delete-morqueData/${id}`);
