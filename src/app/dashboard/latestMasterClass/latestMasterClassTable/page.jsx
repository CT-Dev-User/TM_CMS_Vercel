...
const MasterClassCMS = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = masterClassId
        ? `https://trialtmbackend.vercel.app/api/edit-master-class/${masterClassId}`
        : "https://trialtmbackend.vercel.app/api/add-master-class-page";
  ...
  const fetchMasterClasses = async () => {
    ...
    try {
      const response = await axios.get(
        "https://trialtmbackend.vercel.app/api/get-master-classes"
      );
  ...
  const handleDelete = async (id) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await axios.delete(
            `https://trialtmbackend.vercel.app/api/delete-master-class-by-id/${id}`
          );
