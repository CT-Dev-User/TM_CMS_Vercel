...
const StudentReviewCMS = () => {
  ...
  const fetchStudentReviewData = async () => {
    ...
    try {
      const response = await axios.get(
        "https://trialtmbackend.vercel.app/api/get-all-student-review-data"
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEdit) {
        await axios.put(
          `https://trialtmbackend.vercel.app/api/edit-student-review-data/${editId}`,
          formDataToSend
        );
        Swal.fire("Success", "Add St Review successfully", "success");
      } else {
        await axios.post(
          "https://trialtmbackend.vercel.app/api/add-student-review-data",
          formDataToSend
        );
  ...
  const handleDelete = async (id) => {
    try {
      ...
      if (result.isConfirmed) {
        await axios.delete(
          `https://trialtmbackend.vercel.app/api/delete-student-review-data/${id}`
        );
        Swal.fire(
          "Deleted!",
