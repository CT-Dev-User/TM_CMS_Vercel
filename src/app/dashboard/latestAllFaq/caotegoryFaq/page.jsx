...
const FaqByCategoryTable = () => {
  ...
  const fetchFaqs = async () => {
    try {
      const response = await axios.get(
        "https://trialtmbackend.vercel.app/api/get-all-faq-by-category-data"
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editMode) {
        await axios.put(
          `https://trialtmbackend.vercel.app/api/edit-faq-by-category-data/${editId}`,
          data
        );
        ...
        await axios.post(
          "https://trialtmbackend.vercel.app/api/add-faq-by-category-data",
          data
        );
  ...
  const handleRemoveFaqData = async (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await axios.delete(
            `https://trialtmbackend.vercel.app/api/delete-faq-by-category-data/${id}`
          );
          Swal.fire({
            icon: "success",
            title: "Deleted!",
