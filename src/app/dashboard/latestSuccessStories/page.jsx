...
const SuccessStoriesTable = () => {
  ...
  const fetchStories = async () => {
    ...
    try {
      const response = await axios.get(
        "https://trialtmbackend.vercel.app/api/get-all-success-story-data"
      );
  ...
  const handleDelete = async (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await axios.delete(
            `https://trialtmbackend.vercel.app/api/delete-success-story-data/${id}`
          );
          Swal.fire({
            icon: "success",
            title: "Deleted!",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        "https://trialtmbackend.vercel.app/api/add-success-story-data",
        formDataToSend,
        {
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      await axios.put(
        `https://trialtmbackend.vercel.app/api/edit-success-story-data/${editFormData.id}`,
        formDataToSend,
        {
          headers: { "Content-Type": "multipart/form-data" },
        }
