...
const OurPartenerTable = () => {
  ...
  const fetchPartners = async () => {
    ...
    try {
      const response = await axios.get(
        "https://trialtmbackend.vercel.app/api/get-all-our-partner-data"
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editMode) {
        await axios.put(
          `https://trialtmbackend.vercel.app/api/edit-our-partner-data/${editId}`,
          data
        );
        ...
        await axios.post("https://trialtmbackend.vercel.app/api/add-our-partner-data", data);
  ...
  const handleRemovePartnerData = async (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await axios.delete(
            `https://trialtmbackend.vercel.app/api/delete-our-partner-data/${id}`
          );
          Swal.fire({
            icon: "success",
            title: "Deleted!",
